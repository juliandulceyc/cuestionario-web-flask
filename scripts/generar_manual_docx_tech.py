"""
Script para generar un archivo Word (.docx) del manual técnico.
Requisitos: python-docx (instalado desde requirements.txt)
Ejecutar desde la raíz del proyecto:

    python scripts/generar_manual_docx_tech.py

Salida: docs/Manual_Tecnico_Completo.docx
"""
...
MANUAL_MD_PATH = os.path.join('docs', 'Manual_Tecnico_Completo.md')
OUTPUT_DOCX_PATH = os.path.join('docs', 'Manual_Tecnico_Completo.docx')
...
def main():
    ...
    # Portada
    add_heading(doc, 'Manual Técnico — Sistema de Evaluación FWS PAN', level=1)
    ...
    if os.path.exists(MANUAL_MD_PATH):
        ...
        add_paragraph(doc, f'No se encontró {MANUAL_MD_PATH}')
